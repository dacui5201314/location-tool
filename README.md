...
- **v3.10 报告质量与用户体验修复 (2026-06-23)**
  - **购物商场识别扩展**：新增万象城/龙湖天街/大悦城等 8 个品牌购物中心关键词；收窄"百货"避免误匹配百货商店/日用百货
  - **市场/专业市场参考层**：新增 market_anchor 分类（农贸/建材/五金/汽配等 17 个关键词），不计入购物商场计数，但进入数据解释与边界
  - **写字楼关键词补采**：新增 7 个写字楼关键词搜索（写字楼/办公楼/商务楼/产业园等），配合名称脱水严格口径
  - **数据质量→数据解释与边界**：三端统一升级，分层展示有效POI/脱水剔除/购物商场/市场/低频零售/便利超市/停车场/银行，零计数时说明严格口径含义
