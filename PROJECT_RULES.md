...
- Codex 是项目总负责、代码审查者、Claude Code 指挥官。Codex 当前重点是判断报告精准度问题、写给 Claude Code 的执行提示词、复核 Claude Code 结果、维护项目交接文档。
...
- 当前最高优先级是 34 个业态报告精准度。PDF 下载、UI 美化、页脚文案、端口清理等除非阻塞精准度验证，否则暂时降级。
...
- 前端/PDF/HTML 展示口径必须一致，但当前阶段若未要求，不主动改 UI/PDF。
