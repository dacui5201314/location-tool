...
.sort-opt { font-size:22rpx; color:#64748b; padding:6rpx 14rpx; border-radius:8rpx; }
...
.error-box { text-align:center; padding:70rpx 28rpx; background:rgba(255,255,255,0.92); border:1px solid rgba(254,202,202,0.9); border-radius:22rpx; }
.error-box text { display:block; font-size:26rpx; color:#dc2626; margin-bottom:16rpx; }
.err-btn { background:#f3f7ff; color:#315bff; border-radius:14rpx; padding:16rpx 40rpx; font-size:28rpx; }
