...
<style scoped>
.records-page { min-height:100vh; padding:0 24rpx 118rpx; padding-bottom:calc(118rpx + env(safe-area-inset-bottom)); background:linear-gradient(180deg,#dce4f2 0%,#e0e8f6 42%,#dce4f2 100%); }
