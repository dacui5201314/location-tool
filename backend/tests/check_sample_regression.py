...
SAMPLES = [
    ...
    {"case_id":"service_beauty_05","expected_model_id": "service_beauty", "model_id": "service_beauty","business_type":"宠物店","brand_name":"","store_size":60,
     "real_data":_make_rd(direct_competitors_200m=0,direct_competitors_500m=0,direct_competitors_1000m=0,stats_500m={"residential":7,"office":1,"schools":1,"subway":0,"bus":2,"parking":1,"shopping":0,"hotels":0,"restaurants":4},nearby_roads=["物业路"]),
     "expected_present":["直接竞品", "暗竞品", "工作室", "物业"],"expected_absent":["市场空白明显","外卖骑手"]},
