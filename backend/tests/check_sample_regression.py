...
SAMPLES = [
    # ── 基础 12 个 ──
    {
        ...
        "expected_model_id": "snack_fast_food", "expected_model_id": "snack_fast_food", "model_id": "snack_fast_food",
    ...
    },
    {
        ...
        "expected_model_id": "food_service", "expected_model_id": "food_service", "model_id": "food_service","business_type": "中餐", "brand_name": "湘菜馆", "store_size": 200,
    ...
    },
    {
        ...
        "expected_model_id": "beverage_dessert", "expected_model_id": "beverage_dessert", "model_id": "beverage_dessert","business_type": "奶茶店", "brand_name": "茶百道", "store_size": 20,
    ...
    },
    {
        ...
        "expected_model_id": "retail_convenience", "expected_model_id": "retail_convenience", "model_id": "retail_convenience","business_type": "便利店", "brand_name": "全家", "store_size": 60,
    ...
    {
        "case_id": "pharmacy_01",
        "expected_model_id": "pharmacy", "expected_model_id": "pharmacy", "model_id": "pharmacy","business_type": "药店", "brand_name": "", "store_size": 80,
    ...
    },
    {
        ...
        "expected_model_id": "retail_shopping", "expected_model_id": "retail_shopping", "model_id": "retail_shopping","business_type": "服装店", "brand_name": "", "store_size": 60,
    ...
    },
    {
        ...
        "expected_model_id": "education_childcare", "expected_model_id": "education_childcare", "model_id": "education_childcare","business_type": "教育培训", "brand_name": "小学生托管服务", "store_size": 100,
        "real_data": _make_rd(direct_competitors_200m=0, direct_competitors_500m=0, direct_competitors_1000m=0,
    ...
    },
    {
        ...
        "expected_model_id": "education_training", "expected_model_id": "education_training", "model_id": "education_training","business_type": "教育培训", "brand_name": "英语培训", "store_size": 80,
    ...
    },
    {
        ...
        "expected_model_id": "service_basic", "expected_model_id": "service_basic", "model_id": "service_basic","business_type": "洗衣店", "brand_name": "", "store_size": 30,
        "real_data": _make_rd(direct_competitors_200m=0, direct_competitors_500m=0, direct_competitors_1000m=0),
        "expected_present": ["直接竞品"],
    ...
    },
    {
        ...
        "expected_model_id": "service_beauty", "expected_model_id": "service_beauty", "model_id": "service_beauty","business_type": "美容美发", "brand_name": "", "store_size": 60,
        "real_data": _make_rd(direct_competitors_200m=0, direct_competitors_500m=0, direct_competitors_1000m=0),
        "expected_present": ["直接竞品"],
    ...
    {
        "case_id": "hotel_01",
        "expected_model_id": "hotel", "expected_model_id": "hotel", "model_id": "hotel","business_type": "酒店", "brand_name": "汉庭", "store_size": 2000,
        "real_data": _make_rd(direct_competitors_200m=0, direct_competitors_500m=0, direct_competitors_1000m=0),
        "expected_present": ["直接竞品"],
        "expected_absent": ["市场空白明显","先发优势","品类切入空间较好","推荐开店"],
    },
    {
        ...
        "expected_model_id": "entertainment", "expected_model_id": "entertainment", "model_id": "entertainment","business_type": "酒吧", "brand_name": "", "store_size": 200,
        "real_data": _make_rd(direct_competitors_200m=0, direct_competitors_500m=0, direct_competitors_1000m=0),
        "expected_present": ["直接竞品"],
        "expected_absent": ["市场空白明显","先发优势","品类切入空间较好","推荐开店"],
    },
    ...
    # ── 补齐 6 个第二样本 ──
    {
        ...
        "expected_model_id": "food_service", "expected_model_id": "food_service", "model_id": "food_service","business_type": "火锅店", "brand_name": "重庆老火锅", "store_size": 250,
    ...
    },
    {
        ...
        "expected_model_id": "beverage_dessert", "expected_model_id": "beverage_dessert", "model_id": "beverage_dessert","business_type": "咖啡店", "brand_name": "瑞幸", "store_size": 15,
    ...
    },
    {
        ...
        "expected_model_id": "retail_convenience", "expected_model_id": "retail_convenience", "model_id": "retail_convenience","business_type": "生鲜店", "brand_name": "社区生鲜", "store_size": 80,
        "real_data": _make_rd(direct_competitors_200m=0, direct_competitors_500m=2, direct_competitors_1000m=4,
    ...
    },
    {
        ...
        "expected_model_id": "retail_shopping", "expected_model_id": "retail_shopping", "model_id": "retail_shopping","business_type": "数码店", "brand_name": "", "store_size": 50,
    ...
    },
    {
        ...
        "expected_model_id": "service_basic", "expected_model_id": "service_basic", "model_id": "service_basic","business_type": "诊所", "brand_name": "", "store_size": 60,
        "real_data": _make_rd(direct_competitors_200m=0, direct_competitors_500m=1, direct_competitors_1000m=2,
    ...
    },
    {
        ...
        "expected_model_id": "service_beauty", "expected_model_id": "service_beauty", "model_id": "service_beauty","business_type": "健身房", "brand_name": "私教工作室", "store_size": 200,
    ...
    # ── 高风险 6 个 ──
    {
        ...
        "expected_model_id": "snack_fast_food", "expected_model_id": "snack_fast_food", "model_id": "snack_fast_food","business_type": "小吃快餐", "brand_name": "麻辣烫", "store_size": 40,
    ...
    },
    {
        ...
        "expected_model_id": "education_childcare", "expected_model_id": "education_childcare", "model_id": "education_childcare","business_type": "教育培训", "brand_name": "午托晚托作业辅导", "store_size": 120,
        "real_data": _make_rd(direct_competitors_200m=0, direct_competitors_500m=0, direct_competitors_1000m=0,
    ...
    },
    {
        ...
        "expected_model_id": "education_training", "expected_model_id": "education_training", "model_id": "education_training","business_type": "教育培训", "brand_name": "美术培训", "store_size": 80,
        "real_data": _make_rd(direct_competitors_200m=0, direct_competitors_500m=0, direct_competitors_1000m=1,
    ...
    },
    {
        ...
        "expected_model_id": "hotel", "expected_model_id": "hotel", "model_id": "hotel","business_type": "酒店", "brand_name": "", "store_size": 3000,
        "real_data": _make_rd(direct_competitors_200m=0, direct_competitors_500m=0, direct_competitors_1000m=0,
    ...
    },
    {
        ...
        "expected_model_id": "entertainment", "expected_model_id": "entertainment", "model_id": "entertainment","business_type": "KTV", "brand_name": "", "store_size": 400,
        "real_data": _make_rd(direct_competitors_200m=0, direct_competitors_500m=0, direct_competitors_1000m=0,
    ...
    # 排斥型 0竞品但需求弱
    {
        ...
        "expected_model_id": "snack_fast_food", "expected_model_id": "snack_fast_food", "model_id": "snack_fast_food","business_type": "小餐饮", "brand_name": "煎饼摊", "store_size": 15,
    ...
    # 半聚集型 有同类但不能直接推荐
    {
        ...
        "expected_model_id": "food_service", "expected_model_id": "food_service", "model_id": "food_service","business_type": "烧烤店", "brand_name": "", "store_size": 150,
    ...
    # 半聚集型茶饮 0竞品不写空白
    {
        ...
        "expected_model_id": "beverage_dessert", "expected_model_id": "beverage_dessert", "model_id": "beverage_dessert","business_type": "饮品店", "brand_name": "", "store_size": 20,
        "real_data": _make_rd(direct_competitors_200m=0, direct_competitors_500m=0, direct_competitors_1000m=1,
    ...
    # 排斥型便利 住宅弱时不写推荐
    {
        ...
        "expected_model_id": "retail_convenience", "expected_model_id": "retail_convenience", "model_id": "retail_convenience","business_type": "小超市", "brand_name": "", "store_size": 40,
        "real_data": _make_rd(direct_competitors_200m=0, direct_competitors_500m=0, direct_competitors_1000m=1,
    ...
    # 中性型药店 医院锚点弱 0竞品不写机会
    {
        ...
        "expected_model_id": "pharmacy", "expected_model_id": "pharmacy", "model_id": "pharmacy","business_type": "药房", "brand_name": "", "store_size": 60,
        "real_data": _make_rd(direct_competitors_200m=0, direct_competitors_500m=0, direct_competitors_1000m=0,
    ...
    # 中性型零售 孤立选址不写机会
    {
        ...
        "expected_model_id": "retail_shopping", "expected_model_id": "retail_shopping", "model_id": "retail_shopping","business_type": "零售店", "brand_name": "", "store_size": 40,
        "real_data": _make_rd(direct_competitors_200m=0, direct_competitors_500m=0, direct_competitors_1000m=0,
    ...
    # 暗竞品型托管 brand_name空+category托管(通过category识别)
    {
        ...
        "expected_model_id": "education_childcare", "expected_model_id": "education_childcare", "model_id": "education_childcare","business_type": "教育培训", "brand_name": "", "category": "小学生课后托管服务", "store_size": 100,
        "real_data": _make_rd(direct_competitors_200m=0, direct_competitors_500m=0, direct_competitors_1000m=0,
    ...
    # 聚集型培训 0竞品需看满班率
    {
        ...
        "expected_model_id": "education_training", "expected_model_id": "education_training", "model_id": "education_training","business_type": "教育培训", "brand_name": "舞蹈培训", "store_size": 100,
        "real_data": _make_rd(direct_competitors_200m=0, direct_competitors_500m=0, direct_competitors_1000m=0,
    ...
    # 暗竞品型洗衣 0POI需提示低收录
    {
        ...
        "expected_model_id": "service_basic", "expected_model_id": "service_basic", "model_id": "service_basic","business_type": "洗衣店", "brand_name": "社区干洗", "store_size": 25,
        "real_data": _make_rd(direct_competitors_200m=0, direct_competitors_500m=0, direct_competitors_1000m=0,
    ...
    # 暗竞品型美业 0POI需提示工作室漏收录
    {
        ...
        "expected_model_id": "service_beauty", "expected_model_id": "service_beauty", "model_id": "service_beauty","business_type": "宠物店", "brand_name": "", "store_size": 50,
        "real_data": _make_rd(direct_competitors_200m=0, direct_competitors_500m=0, direct_competitors_1000m=0,
    ...
    # 聚集型酒店 0竞品+交通弱
    {
        ...
        "expected_model_id": "hotel", "expected_model_id": "hotel", "model_id": "hotel","business_type": "民宿", "brand_name": "", "store_size": 500,
        "real_data": _make_rd(direct_competitors_200m=0, direct_competitors_500m=0, direct_competitors_1000m=0,
    ...
    # 聚集型娱乐 0竞品+合规弱
    {
        ...
        "expected_model_id": "entertainment", "expected_model_id": "entertainment", "model_id": "entertainment","business_type": "台球厅", "brand_name": "", "store_size": 300,
        "real_data": _make_rd(direct_competitors_200m=0, direct_competitors_500m=0, direct_competitors_1000m=0,
    ...
    {"case_id":"service_beauty_05","expected_model_id": "service_beauty", "model_id": "service_beauty","business_type":"宠物店","brand_name":"","store_size":60,
     ...
     "expected_present":["直接竞品", "宠物"],"expected_absent":["市场空白明显","外卖骑手"]},
